...
- Every instance of `a` should be turned into `an` if the next word begins with a vowel (`a`, `e`, `i`, `o`, `u`) or an `h`. (Ex: "There it was. A amazing rock!" -> "There it was. An amazing rock!").
### Allowed packages
